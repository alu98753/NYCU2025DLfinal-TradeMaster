...
def parse_args():
    ...
    parser.add_argument("--config", default=osp.join(ROOT, "configs", "portfolio_management", "portfolio_management_tw50_eiie_eiie_adam_mse.py"),
...
def main():
    ...
    action_dim = train_environment.action_dim # 49
