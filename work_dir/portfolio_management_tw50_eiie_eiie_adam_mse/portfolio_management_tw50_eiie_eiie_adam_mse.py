...
trainer = dict(
    ...
    if_remove=False,
    calibrate_marketnet_flag=True,
    calibrate_marketnet_every_n_epochs=1,
    marketnet_calibrate_epochs=1000,
    marketnet_calibrate_lr=0.0001,
    marketnet_calibrate_batch_size=32,
    marketnet_target_accuracy_bull=0.97,
    marketnet_target_accuracy_bear=0.97,
    marketnet_weight_decay=0.0001)
loss = dict(type='MSELoss')
optimizer = dict(type='AdamW', lr=4e-05, weight_decay=0.001)
eiie_d_model = 64
act = dict(
    type='EIIEConv',
    input_dim=13,
    ...
    top_k_stocks_to_select=10,
    default_bull_stock_alloc=0.9)
cri = dict(
    type='EIIECritic',
    input_dim=13,
    action_dim=49,
    ...
    num_market_regimes=2)
market_net = dict(
    type='MarketNet',
    input_s_market_dim=64,
    hidden_dim=256,
    num_classes=2,
    dropout_p=0.1)
